...
<body id="sign-in">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <form id="loginForm" action="{{ route('users.login.request') }}" class="loginForm" method="post" class="">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="default_id" class="sr-only">Examiners ID</label>
                                                        <input type="default_id" class="form-control form-control-lg input-lg" id="default_id" name="default_id" placeholder="Examiners ID">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group text-right">
                                                        <a href="{{ route('users.register.page') }}" style="color: #000080;">Don't have an account? Register here.</ac>
    ...
    <!-- global js -->
    <script src="{{ asset('auth/js/jquery.min.js') }}" type="text/javascript"></script>
