...
Route::get('/register', [AuthController::class, 'ExamineesRegisterPage'])->name('users.register.page');
Route::post('/register/request', [AuthController::class, 'ExamineesRegisterRequest'])->name('users.register.request');
